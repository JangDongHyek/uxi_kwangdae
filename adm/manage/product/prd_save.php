...
$content_m = mysql_real_escape_string($content_m);
...
if($mode == "insert"){
	...
	$sql = "insert into wiz_product
					...
					comcnt,sellprice,conprice,reserve,reserve_percent,strprice,new,best,popular,recom,sale,shortage,coupon_use,coupon_dis,coupon_type,
					...
					option_use, select_subjects, supply_subjects,delprice,
					...
					'$deimgcnt','$basketcnt','$ordercnt','$cancelcnt','$comcnt','$sellprice','$conprice','$reserve','$reserve_percent','$strprice','$new',
	...
	// 옵션값 저장
	$sql = "insert into wiz_product_option
					(prdcode, type, `table`)
					values('$prdcode', 'select', '$select_table') ";

	mysql_query($sql) or die(mysql_error());

	$sql = "insert into wiz_product_option
					(prdcode, type, `table`)
					values ('$prdcode', 'supply', '$supply_table')";
...
//////////////////////////////////////////////////////////////////////////////////////////
	...
	$sql = "update wiz_product set
	            ...
	            sellprice='$sellprice', conprice='$conprice', reserve='$reserve', reserve_percent='$reserve_percent', strprice='$strprice', new='$new', best='$best', popular='$popular', recom='$recom', sale='$sale',
	            ...
	            info_name5='$info_name5',info_value5='$info_value5',info_name6='$info_name6',info_value6='$info_value6',
							option_use=$option_use, select_subjects='$select_subjects', supply_subjects='$supply_subjects', delprice='$delprice',
	...
	$sql = "update wiz_product_option set `table`='$select_table' where prdcode='$prdcode' and type='select'";
	mysql_query($sql) or error(mysql_error());

	$sql = "update wiz_product_option set `table`='$supply_table' where prdcode='$prdcode' and type='supply'";
	mysql_query($sql) or error(mysql_error());
...
//////////////////////////////////////////////////////////////////////////////////////////
  ...
  $prd_info->prior = $prior;
	...
	$sql = "insert into wiz_product(
					...
					sellprice,conprice,reserve,reserve_percent,strprice,new,best,popular,recom,sale,shortage,del_type,del_price,prdicon,prefer,brand,
					...
					option_use, select_subjects, supply_subjects,
					prdimg_R,prdimg_L1,prdimg_M1,prdimg_S1,prdimg_L2,prdimg_M2,prdimg_S2,prdimg_L3,prdimg_M3,prdimg_S3,
					prdimg_L4,prdimg_M4,prdimg_S4,prdimg_L5,prdimg_M5,prdimg_S5,searchkey,stortexp,content,content_m,wdate,mdate
					)
					values(
					...
					'$prd_info->sellprice','$prd_info->conprice','$prd_info->reserve','$prd_info->reserve_percent','$prd_info->strprice','$prd_info->new','$prd_info->best','$prd_info->popular','$prd_info->recom','$prd_info->sale','$prd_info->shortage',
					...
					$prd_info->option_use,'$prd_info->select_subjects', '$prd_info->supply_subjects',
	...
	// 옵션 정보 저장
	$sql = "select * from wiz_product_option where prdcode='$prd_info->prdcode'";
	$result = mysql_query($sql) or error(mysql_error());
	while($row = mysql_fetch_object($result)){
		$sql = "insert into wiz_product_option (prdcode, type, `table`) values ('$prdcode', '$row->type', '$row->table')";
		mysql_query($sql) or error(mysql_error());
	}
