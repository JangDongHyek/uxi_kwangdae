...
<div class="join_input_cont">
	<table id="join_table_style" width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td>
            	<input id="j_phone1" name="tphone1" type="text" class="input w40" maxlength="3"/>
				-
                <input id="j_phone2" name="tphone2" type="text" class="input w40" maxlength="4"/>
                -
                <input id="j_phone3" name="tphone3" type="text" class="input w40" maxlength="4"/>
            </td>
        </tr>
        <?=$hide_tphone_end?>
	        ...
	        <tr>
	          ...
	          <td>
		          ...
		          <td>
		          	<input id="j_tel1" name="hphone1" type="text" class="input w40" maxlength="3"/>
		              -
		              <input id="j_tel2" name="hphone2" type="text" class="input w40" maxlength="4"/>
		              -
		              <input id="j_tel3" name="hphone3" type="text" class="input w40" maxlength="4"/>
		              <?=$hide_reemail_start?>
		              <font class="comment left10">SMS 받으시겠습니까?</font>
		              <font class="comment left10"><input name="resms" type="radio" value="Y" id="resms" checked /> <label for="resms">예</label></font>
		              <font class="comment left10"><input name="resms" type="radio"  class="radio" value="N" id="resmsn" /> <label for="resmsn">아니오</label></font>
